            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        /********************* por ********************************************/
                        var questionTextHTML = $('<div class="four columns"></div>'),
                            questionImgHTML = $('<div class="seven columns"></div>');
                        questionTextHTML.append('<h3>' + formatQuestion + '</h3>');
                        questionImgHTML.append('<img class="questionImage" src=' + question.img + '>');
                        /**********************************************************************/
                        ...
                        /********************* por ********************************************/
                        questionTextHTML.append(answerHTML);
                        /**********************************************************************/
                        ...
                        if (plugin.config.perQuestionResponseMessaging || plugin.config.completionResponseMessaging) {
                            ...
                            /********************* por ********************************************/
                            questionTextHTML.append(responseHTML);
                            /**********************************************************************/
                        ...
                        if (!plugin.config.perQuestionResponseMessaging) {
                            ...
                            /********************* por ********************************************/
                            questionTextHTML.append('<a href="#" class="button ' + nextQuestionClass + '">' + nextText + '</a>');
                            questionTextHTML.append('<a href="#" class="button ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                            /**********************************************************************/
                        }

                        /************************ inserindo *************************************/
                        questionHTML.append(questionTextHTML);
                        questionHTML.append(questionImgHTML);
                        /************************************************************************/
